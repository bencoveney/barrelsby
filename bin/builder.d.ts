...
export declare function buildBarrels(destinations: Directory[], quoteCharacter: QuoteCharacter, semicolonCharacter: SemicolonCharacter, barrelName: string, logger: Logger, baseUrl: BaseUrl, structure: StructureOption | undefined, local: boolean, include: string[], exclude: string[]): void;
