    ...
    describe("buildFileSystemBarrel function that", () => {
        describe("when using the default settings", () => {
            ...
            beforeEach(() => {
                ...
                output = FileSystem.buildFileSystemBarrel(rootDirectory, TestUtilities.mockModules(rootDirectory), '"', ";", logger, undefined, false, false);
            });
...
`);
    ...
    describe("when using extension suffix", () => {
        ...
        beforeEach(() => {
            const rootDirectory = TestUtilities.mockDirectoryTree();
            output = FileSystem.buildFileSystemBarrel(rootDirectory, TestUtilities.mockModules(rootDirectory), '"', "", logger, undefined, false, true);
        });
        it("should produce the correct output", () => {
            TestUtilities.assertMultiLine(output, `import * as barrelts from "./barrel.js"
