...
const destinations_1 = require("./destinations/destinations");
const buildTree_1 = require("./fileTree/buildTree");
...
const purge_1 = require("./purge/purge");
...
function main(args) {
    ...
    const rootTree = buildTree_1.buildTree(rootPath, barrelName, logger);
